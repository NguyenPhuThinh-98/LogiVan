<%@ Page Title="" Language="C#" MasterPageFile="~/LogiVan.Master" AutoEventWireup="true" CodeBehind="admin-loai-hang.aspx.cs" Inherits="LogiVan_New.admin_loai_hang" %>
    ...
    <div>
        ...
        <asp:MultiView ID="MultiView1" runat="server">
            <asp:View ID="ViewInsert" runat="server">
                <table class="table">
                    <tr>
                        <th>Tên loại hàng mới</th>
                        <td>
                            <asp:TextBox ID="inTenLoaiHang" runat="server" CssClass="textbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
