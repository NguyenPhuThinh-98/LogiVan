<%@ Page Title="" Language="C#" MasterPageFile="~/LogiVan.Master" AutoEventWireup="true" CodeBehind="admin-tin-tuc.aspx.cs" Inherits="LogiVan_New.admin_tin_tuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:GridView ID="GridView1" runat="server" Width="100%" AllowPaging="True" CellPadding="4" ForeColor="#333333" 
            GridLines="None" AutoGenerateColumns="false" OnRowDataBound="GridView1_RowDataBound" PageSize="5" 
            ...
            <asp:View ID="ViewUpdate" runat="server">
                <table class="table">
                    <tr>
                        <th>Mã tin tức</th>
                        <td colspan="2">
                            <asp:DropDownList ID="updateMaTinTuc" runat="server" CssClass="ddl" AutoPostBack="True" OnSelectedIndexChanged="updateMaTinTuc_SelectedIndexChanged"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <th>Ảnh</th>
