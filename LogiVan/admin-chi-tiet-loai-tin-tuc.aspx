<%@ Page Title="" Language="C#" MasterPageFile="~/LogiVan.Master" AutoEventWireup="true" CodeBehind="admin-chi-tiet-loai-tin-tuc.aspx.cs" Inherits="LogiVan.admin_chi_tiet_loai_tin_tuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:GridView ID="GridView1" runat="server" Width="100%" Font-Size="XX-Large" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None">
